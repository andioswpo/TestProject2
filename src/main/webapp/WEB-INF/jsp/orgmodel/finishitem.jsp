...
{
	var url = row.url+'?status=end&instanceid='+row.instanceId+'&instworkitemid='+row.id+'&instactivityid='+row.instActivityId+'&instprocessid='+row.instProcessId;
...
<body class="easyui-layout">
	<div data-options="region:'center'">
		<table id="workitemdg" class="easyui-datagrid" style="width:100%;height:100%"   
		        data-options="url:'/finishitemlist.action',fitColumns:true">   
		    <thead>   
		        <tr>
